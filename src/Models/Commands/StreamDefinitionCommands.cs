...
public abstract record UpdateStatusCommand(
    IStreamDefinition affectedResource,
...
/// </summary>
/// <param name="affectedResource"></param>
public abstract record SetErrorStatus(IStreamDefinition affectedResource) : UpdateStatusCommand(affectedResource: affectedResource,
    conditions: V1Alpha1StreamCondition.ErrorCondition,
...
/// </summary>
/// <param name="affectedResource"></param>
public abstract record SetCustomErrorStatus(IStreamDefinition affectedResource, V1Alpha1StreamCondition[] conditions) : UpdateStatusCommand(
...
/// </summary>
/// <param name="affectedResource"></param>
public abstract record SetWarningStatus(IStreamDefinition affectedResource, StreamPhase phase) : UpdateStatusCommand(
    affectedResource: affectedResource,
    conditions: V1Alpha1StreamCondition.WarningCondition, phase: phase);

/// <summary>
/// Abstract class for setting error status
/// </summary>
/// <param name="affectedResource"></param>
public abstract record SetReadyStatus(IStreamDefinition affectedResource, StreamPhase phase) : UpdateStatusCommand(affectedResource: affectedResource,
    conditions: V1Alpha1StreamCondition.ReadyCondition, phase: phase);
...
/// </summary>
/// <param name="affectedResource"></param>
public record SetInternalErrorStatus(IStreamDefinition affectedResource, V1Alpha1StreamCondition[] conditions)
    : SetCustomErrorStatus(affectedResource: affectedResource, conditions: conditions);

/// <summary>
/// Sets the stream definition status to Suspended
/// </summary>
/// <param name="affectedResource"></param>
public record Suspended(IStreamDefinition affectedResource) : SetWarningStatus(affectedResource: affectedResource, phase: StreamPhase.SUSPENDED);

/// <summary>
/// Sets the stream definition status to Reloading
/// </summary>
/// <param name="affectedResource"></param>
public record Reloading(IStreamDefinition affectedResource) : SetReadyStatus(affectedResource: affectedResource, phase: StreamPhase.RELOADING);

/// <summary>
/// Sets the stream definition status to Running
/// </summary>
/// <param name="affectedResource"></param>
public record Running(IStreamDefinition affectedResource) : SetReadyStatus(affectedResource: affectedResource, phase: StreamPhase.RUNNING);
...
public record SetCrashLoopStatusAnnotationCommand(IStreamDefinition affectedResource) :
    SetAnnotationCommand<IStreamDefinition>(
        ...
        annotationValue: Annotations.CRASH_LOOP_STATE_ANNOTATION_VALUE);
