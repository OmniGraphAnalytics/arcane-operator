...
public static class JsonElementExtensions
{
    ...
    {
        return jsonElement.Deserialize<StreamDefinition>()?.AsOption<IStreamDefinition>() ?? Option<IStreamDefinition>.None;
    }
    ...
    {
        return jsonElement.Deserialize<V1Beta1StreamClass>()?.AsOption<IStreamClass>() ?? Option<IStreamClass>.None;
    }
}
