...
public interface IStreamClass : IKubernetesObject<V1ObjectMeta>
{
    ...
    private static RestartSettings DefaultRestartSettings =>
        RestartSettings.Create(minBackoff: TimeSpan.FromSeconds(1), maxBackoff: TimeSpan.FromSeconds(30), randomFactor: 0.2)
            .WithMaxRestarts(count: 20, within: TimeSpan.FromMinutes(10));
